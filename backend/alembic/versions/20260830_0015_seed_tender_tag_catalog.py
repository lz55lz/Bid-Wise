...
数据来自旧项目版本控制迁移 202608310002，不依赖已删除的旧数据库。
...
INSERT INTO tender_tag_categories (code, name, description, sort_order) VALUES
    ...
    op.get_bind().exec_driver_sql("""
INSERT INTO tender_tag_levels (code, name, description, sort_order) VALUES
        ('P0', '关键必填', '必须100%%提取', 1),
        ('P1', '重要推荐', '强烈建议提取', 2),
        ('P2', '一般可选', '辅助分析参考', 3)
        ON CONFLICT (code) DO NOTHING
    ...
    op.get_bind().exec_driver_sql("""
INSERT INTO tender_tags (code, name, category_code, level_code, data_type, is_required, is_multi_value, extraction_prompt, value_example) VALUES
...
INSERT INTO tender_tags (code, name, category_code, level_code, data_type, is_required, is_multi_value, extraction_prompt, value_example) VALUES
    ...
    op.get_bind().exec_driver_sql("""
INSERT INTO tender_tag_relations (source_tag_code, target_tag_code, relation_type, description, rule) VALUES
